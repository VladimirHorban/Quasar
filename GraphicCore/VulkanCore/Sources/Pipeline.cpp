...
std::vector<char> GraphicPipeline::readFile(const VkDevice& aDevice, const char* aFileName)
{
...
VkShaderModule GraphicPipeline::createShaderModule(const VkDevice& aDevice, const char* aFileName)
{
